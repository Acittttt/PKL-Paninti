...
//
//    inner class WeatherHomeViewHolder: RecyclerView.ViewHolder(binding.root){
//        fun setData(item : WeatherHome){
//            binding.apply {
//                binding.percen.text = item.percen
...
//
//    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) : WeatherHomeViewHolder {
//        binding = FragmentListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
